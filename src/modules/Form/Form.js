        ...
        >
          <FormGroup className={"players-form"}>
            ...
            <div className="control-buttons">
              <Button onClick={clearFields} variant={"outlined"} className={"form-control-button"}>Clear</Button>
              <Button type={"submit"} variant={"outlined"} className={"form-control-button"} disabled={!fieldsFilled || errors.name || errors.surname || errors.gamesPlayed || errors.price}>
                Save
              </Button>
            </div>
          </FormGroup>
